...
export function buildSections(
  ...
  return [
    { id: "home", label: "Home", create: () => new HomeView(ctx, repo) },
    {
      id: "evolutions",
      label: "Evolutions",
      create: () => new EvolutionsView(ctx, repo, navigate),
    },
    {
      id: "weapons",
      label: "Weapons",
      create: () => new WeaponsView(ctx, repo, navigate),
    },
    {
      id: "passives",
      label: "Passives",
      create: () => new PassivesView(ctx, repo, navigate),
    },
    {
      id: "characters",
      label: "Characters",
      create: () => new CharactersView(ctx, repo, navigate),
    },
    {
      id: "stages",
      label: "Stages",
      create: () => new StagesView(ctx, repo, navigate),
    },
    {
      id: "arcanas",
      label: "Arcanas",
      create: () => new ArcanasView(ctx, repo, navigate),
    },
    {
      id: "bestiary",
      label: "Bestiary",
      create: () => new BestiaryView(ctx, repo, navigate),
    },
  ];
}
